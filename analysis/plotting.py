...
def scatters(subject_list, save_fig, data_dir, x, y, condition1, condition2, annotate_plot=False):
	'''
...
def scene_cut_erp(data_dir, textgrid_dir, subject_list, block=1, fs=128., uV_scale=1e-6, tmin=-0.3,
	tmax=0.5, colors=['r', 'b'], plot_grand=True, plot_individual_figs=False):
...
def mouth_erp(data_dir, textgrid_talker_dir, save_fig, subject_list, elecs, elec_type, condition='AV', 
	...
	return congruent_resp, incongruent_resp
...
# 	#corrs, wts, wts2 = visualize_wts('MT0033', data_dir, 'pitchenvsphnfeat', ['AV', 'A'], save_fig, delay_min=0.0, delay_max=0.6, fs=128.)
